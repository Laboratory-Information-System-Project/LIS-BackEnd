pipeline {
    ...
    stages {
        stage('Prepare') {
            steps {
                git url: 'https://github.com/Laboratory-Information-System-Project/LIS-backend.git',
                    branch: 'develop',
...
//         }
        ...
        stage('Dockerizing'){
            steps{
                ...
                sh 'docker build . -t suk97/lis-backend'
            }
            post {
                success {
                ...
                echo 'Push Docker'
                    script {
                        docker.withRegistry('https://registry.hub.docker.com', 'docker'){
                            ...
                            sh 'docker push suk97/lis-backend'
                        }
                    }
            }
        }
...
//         stage('Deploy') {
//             steps {
//                 sh 'docker run --name deploy-test2 -d -p 8081:8081 suk97/lis-backend'
//             }
//
//             post {
//                 success {
