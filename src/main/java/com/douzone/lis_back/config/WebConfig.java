...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:3000","https://dpiezv2v8sa5.cloudfront.net","http://localhost:8080","http://35.78.53.64:8080", "http://lis-front-deploy-bucket.s3-website.ap-northeast-2.amazonaws.com/")
