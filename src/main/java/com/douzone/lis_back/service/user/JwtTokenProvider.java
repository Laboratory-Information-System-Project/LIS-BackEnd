...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(@Value("${jwt.secret}") String secretKey, UserMapper userRepository) {
...
//                .compact();
        ...
        return TokenInfo.builder()
                ...
                .name(userRepository.findByUsername(authentication.getName()).map(com.douzone.lis_back.domain.user.User::getName).get())
                .userId(userRepository.findByUsername(authentication.getName()).map(com.douzone.lis_back.domain.user.User::getUserId).get())
